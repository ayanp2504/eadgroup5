...
<head>
    ...
    <!-- Title Page-->
    <title>Add Employee | UIC HR System</title>
    ...
    <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title" style="font-family: 'Century Gothic">Registration Info</h2>
                    <form action="process/addempprocess.php" method="POST" enctype="multipart/form-data" style="font-family: 'Century Gothic">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="number" placeholder="SSN" name="nid" required="required">
                        </div>
                        ...
                        <div class="p-t-20">
                            <button class="btn btn--radius btn--green" type="submit" style="font-family: 'Century Gothic">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
