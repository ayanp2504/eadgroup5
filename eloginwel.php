...
<head>
	<title>Employee Panel | UIC HR System</title>
	<link rel="stylesheet" type="text/css" href="styleemplogin.css">
	<link href="https://fonts.googleapis.com/css?family=Century Gothic|Montserrat" rel="stylesheet">
</head>
...
<body>
	...
	<div id="divimg">
		<div>
			...
			<h2 style="font-family: 'Century Gothic', sans-serif; font-size: 25px; text-align: center;">Empolyee
				Leaderboard </h2>
